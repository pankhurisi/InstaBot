...
# paralleldot token generated by me
APP_ACCESS_TOKEN_PARALLEL_DOT = 'a95db2b0b5b9476fa77ceace841c34f1'

# base url for insta and paralleldot
    ...
    if media_info is not None:
        ...
        if media_info['meta']['code'] == 200:
            ...
            if media_info['data']['caption'] is not None:
                ...
                code = insta_caption.encode('ascii','ignore')
                print type(code)
                option_function = get_parallel_dots_keyword(code, APP_ACCESS_TOKEN_PARALLEL_DOT)
